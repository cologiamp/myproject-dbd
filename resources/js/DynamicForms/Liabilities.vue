...
const stepForm = useForm(`EditLiabilities${ props.formData.model.client_id }`, {
        ...
        <div class="form-row flex-1">
            ...
            <div v-for="(liability, index) in stepForm.liabilities"
                ...
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                    ...
                    <select @change="autosaveT(stepForm,props.formData.submit_url)" v-model="liability.owner"
                        id="owner" name="owner"
                ...
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                    ...
                    <select @change="autosaveT(stepForm,props.formData.submit_url)" v-model="liability.type"
                ...
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                    ...
                    <select @change="autosaveT(stepForm,props.formData.submit_url)" v-model="liability.repayment"
                ...
                <div class="mt-2 md:mt-0 md:pr-2 md:col-span-3">
                    ...
                    <div class="flex shadow-sm rounded-md  focus-within:ring-2 focus-within:ring-inset focus-within:ring-red-300 sm:max-w-md">
                        <input @change="autosaveT(stepForm,props.formData.submit_url)" type="text" name="lender" id="lender" v-model="liability.lender" class="block ring-1 ring-inset ring-aaron-500 flex-1 border-0 rounded-md bg-aaron-950 py-1.5 pl-2 text-aaron-50 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none" placeholder="Lender" />
                    </div>
                ...
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                    ...
                    <div class="pt-1 flex items-center space-x-4 space-y-0 md:mt-0 md:pr-2 md:col-span-2">
                        <input @change="autosaveT(stepForm,props.formData.submit_url)" v-model="liability.is_to_be_repaid" type="radio" id="true" :value="true"
                        ...
                        <input @change="autosaveT(stepForm,props.formData.submit_url)" v-model="liability.is_to_be_repaid" type="radio" id="false" :value="false"
