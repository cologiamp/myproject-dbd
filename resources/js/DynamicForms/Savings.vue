...
const stepForm = useForm(`EditSavingAssets${ props.formData.model.client_id }`, {
    saving_assets: props.formData.model.saving_assets
})

function removeAsset(index) {
    console.log(stepForm.saving_assets[index]);
...
<!--                Asset Type-->
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                    ...
                    <select @change="autosaveT(stepForm,props.formData.submit_url)" v-model="asset.provider"
                ...
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                    ...
                    <select @change="autosaveT(stepForm,props.formData.submit_url)" v-model="asset.account_type"
                            id="asset_type" name="asset_type"
                            class="block rounded-md  w-full  border-0 py-1.5 bg-aaron-700 text-aaron-50 sm:max-w-md shadow-sm ring-1 ring-inset ring-aaron-600 focus:ring-2 focus:ring-inset focus:ring-red-300  sm:text-sm sm:leading-6 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none">
                        <option id="asset_type" :value="null">-</option>
                ...
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                    ...
                    <div class="flex shadow-sm rounded-md   focus-within:ring-2 focus-within:ring-inset focus-within:ring-red-300 sm:max-w-md">
                        <input @change="autosaveT(stepForm,props.formData.submit_url)" v-model="asset.name" type="text" class="block ring-1 ring-inset ring-aaron-500 flex-1 border-0 rounded-md bg-aaron-950 py-1.5 pl-2 text-aaron-50 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 disabled:bg-aaron-800 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none"  />
                    </div>
                </div>
                ...
                <div class="col-span-6 grid grid-cols-6 rounded-md bg-aaron-950 pt-2 p-4">
                    ...
                    <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                        ...
                        <div class="pt-1 flex items-center space-x-4 space-y-0 md:mt-0 md:pr-2 md:col-span-2">
                            <input @change="autosaveT(stepForm,props.formData.submit_url)" v-model="asset.regular_contributions" type="radio" id="true" :value="true" :checked="asset.regular_contributions == true" class="h-4 w-4 border-gray-300 text-aaron-700 focus:ring-aaron-700" />
                            <label for="true" class="ml-2 block text-sm font-medium leading-6 text-white">Yes</label>
                            <input @change="autosaveT(stepForm,props.formData.submit_url)" v-model="asset.regular_contributions" type="radio" id="false" :value="false" :checked="asset.regular_contributions == false" class="h-4 w-4 border-gray-300 text-aaron-700 focus:ring-aaron-700" />
