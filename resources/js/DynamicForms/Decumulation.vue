    ...
    <dynamic-form-wrapper :saving="autoS">
        <div class="flex flex-col justify-center w-full lg:w-6/12 mx-auto">
            <div class="mb-4 mt-4 w-full">
                ...
                <div class="grid gap-2 md:grid md:items-start md:gap-y-8 md:gap-x-4 py-2">
            ...
            <div class="mb-4 mt-4 w-full">
                <h1 class="text-2xl pb-4">Sources of pension income</h1>
            ...
            <div class="mb-4 mt-4 w-full">
                <h1 class="text-2xl pb-4">Spouse/Partner's Pensions</h1>
            ...
            <div class="mb-4 mt-4 w-full">
                <h1 class="text-2xl pb-4">Tax free cash lump sum </h1>
            ...
            <div class="mb-4 mt-4 w-full">
                <h1 class="text-2xl pb-4">Lump sum death benefits </h1>
