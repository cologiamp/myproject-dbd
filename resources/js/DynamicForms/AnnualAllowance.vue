...
const stepForm = useForm(props.formData.submit_method, props.formData.submit_url,{
    ...
    pension_recommendation_id: props.formData.model.pension_recommendation_id,
    dd_pcls_spend: props.formData.model.dd_pcls_spend,
    dd_pcls_income: props.formData.model.dd_pcls_income,
    dd_income: props.formData.model.dd_income
})
...
async function autosaveLocally(index){
    ...
    stepForm.pension_recommendation_id = props.formData.model.pension_recommendation_id,
    stepForm.dd_pcls_spend = props.formData.model.dd_pcls_spend,
    stepForm.dd_pcls_income = props.formData.model.dd_pcls_income,
    stepForm.dd_income = props.formData.model.dd_income
}
        ...
        <div class="form-row flex-1">
            ...
            <div v-for="(allowance, index) in stepForm.pr_annual_allowances" class="grid gap-2 mb-6 md:grid md:grid-cols-6 md:items-start md:gap-y-4 md:gap-x-4 border-b-2 border-aaron-500 pb-12 last-of-type:border-b-0 last-of-type:pb-0">
                <div class="md:col-span-6 flex flex-row justify-between">
                    ...
                    <button type="button" @change="removeAllowance(index)"
