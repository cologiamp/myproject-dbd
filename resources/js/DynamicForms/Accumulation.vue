...
async function autosaveLocally(){
    ...
    stepForm.additional_contributions = props.formData.model.additional_contributions;
    stepForm.in_specie_transfers = props.formData.model.in_specie_transfers;
    stepForm.if_experience_self_select = props.formData.model.if_experience_self_select;
    stepForm.if_experience_lifestyle = props.formData.model.if_experience_lifestyle;
    stepForm.if_experience_advisory = props.formData.model.if_experience_advisory;
    stepForm.if_experience_discretionary = props.formData.model.if_experience_discretionary;
    stepForm.is_explained = props.formData.model.is_explained;
    stepForm.preferred_option = props.formData.model.preferred_option;
    stepForm.preferred_explanation = props.formData.model.preferred_explanation;
    stepForm.wide_range_of_assets = props.formData.model.wide_range_of_assets;
    stepForm.include_exclude_specifics = props.formData.model.include_exclude_specifics;
    stepForm.require_flexibility = props.formData.model.require_flexibility;
    stepForm.retirement_vs_legacy = props.formData.model.retirement_vs_legacy;
    stepForm.retirement_vs_legacy_specifics = props.formData.model.retirement_vs_legacy_specifics;
    stepForm.dependents_suffer = props.formData.model.dependents_suffer;
    stepForm.iht_concerns = props.formData.model.iht_concerns;
        ...
        <div class="flex flex-col justify-center w-full md:w-6/12 mx-auto">
            ...
            <div class="mb-4 mt-4 w-full">
                ...
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2 py-2">
                    ...
                    <select @change="autosaveLocally()" v-model="stepForm.if_experience_lifestyle" id="unit" name="if_experience_lifestyle"  class="block rounded-md w-6/12 border-0 py-1.5 bg-aaron-700 text-aaron-50 sm:max-w-md shadow-sm ring-1 ring-inset ring-aaron-600 focus:ring-2 focus:ring-inset focus:ring-red-300  sm:text-sm sm:leading-6 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none">
                ...
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2 py-2">
                    ...
                    <select @change="autosaveLocally()" v-model="stepForm.if_experience_discretionary" id="unit" name="if_experience_discretionary"  class="block rounded-md w-6/12 border-0 py-1.5 bg-aaron-700 text-aaron-50 sm:max-w-md shadow-sm ring-1 ring-inset ring-aaron-600 focus:ring-2 focus:ring-inset focus:ring-red-300  sm:text-sm sm:leading-6 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none">
                ...
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2 py-2">
                    ...
                    <select @change="autosaveLocally()" v-model="stepForm.preferred_option" id="unit" name="preferred_option"  class="block rounded-md w-6/12 border-0 py-1.5 bg-aaron-700 text-aaron-50 sm:max-w-md shadow-sm ring-1 ring-inset ring-aaron-600 focus:ring-2 focus:ring-inset focus:ring-red-300  sm:text-sm sm:leading-6 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none">
            ...
            <div class="mb-4 mt-4 w-full">
                ...
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2 py-2">
                    ...
                    <select @change="autosaveLocally()" v-model="stepForm.retirement_vs_legacy" id="unit" name="retirement_vs_legacy"  class="block rounded-md w-6/12 border-0 py-1.5 bg-aaron-700 text-aaron-50 sm:max-w-md shadow-sm ring-1 ring-inset ring-aaron-600 focus:ring-2 focus:ring-inset focus:ring-red-300  sm:text-sm sm:leading-6 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none">
