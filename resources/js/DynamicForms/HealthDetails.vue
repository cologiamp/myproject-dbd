...
async function autosaveLocally(){
    ...
    stepForm.is_in_good_health = props.formData.model.is_in_good_health;
    stepForm.health_details = props.formData.model.health_details;
    stepForm.has_life_expectancy_concerns = props.formData.model.has_life_expectancy_concerns;
    stepForm.life_expectancy_details = props.formData.model.life_expectancy_details;
    stepForm.medical_conditions = props.formData.model.medical_conditions;
    stepForm.smoker = props.formData.model.smoker;
    stepForm.smoked_in_last_12_months = props.formData.model.smoked_in_last_12_months;
}
            ...
            <div class="grid gap-2 md:grid md:grid-cols-6 md:items-start md:gap-y-8 md:gap-x-4">
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2 h-36">
                    ...
                    <div class="pt-1 flex items-center space-x-4 space-y-0 md:mt-0 md:pr-2 md:col-span-2">
                        <input @change="autosaveLocally()" v-model="stepForm.is_in_good_health" type="radio" id="true" :value="true" :checked="stepForm.is_in_good_health == true" class="h-4 w-4 border-gray-300 text-aaron-700 focus:ring-aaron-700" />
                        <label for="true" class="ml-2 block text-sm font-medium leading-6 text-white">Yes</label>
                        <input @change="autosaveLocally()" v-model="stepForm.is_in_good_health" type="radio" id="false" :value="false" :checked="stepForm.is_in_good_health == false" class="h-4 w-4 border-gray-300 text-aaron-700 focus:ring-aaron-700" />
                ...
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                    <div v-if="stepForm.is_in_good_health == false">
                        ...
                        <div class="mt-2">
                            <textarea @change="autosaveLocally()" v-model="stepForm.health_details" rows="3" name="health_details" id="health_details" class="block w-full rounded-md border-0 py-1.5 text-aaron-50 bg-aaron-950 shadow-sm ring-1 ring-inset ring-aaron-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-aaron-500 sm:text-sm sm:leading-6"></textarea>
                        </div>
                    </div>
                </div>
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2 h-36">
                    ...
                    <div class="pt-1 flex items-center space-x-4 space-y-0 md:mt-0 md:pr-2 md:col-span-2">
                        <input @change="autosaveLocally()" v-model="stepForm.has_life_expectancy_concerns" type="radio" id="true" :value="true" :checked="stepForm.has_life_expectancy_concerns == true" class="h-4 w-4 border-gray-300 text-aaron-700 focus:ring-aaron-700" />
                        <label for="true" class="ml-2 block text-sm font-medium leading-6 text-white">Yes</label>
                        <input @change="autosaveLocally()" v-model="stepForm.has_life_expectancy_concerns" type="radio" id="false" :value="false" :checked="stepForm.has_life_expectancy_concerns == false" class="h-4 w-4 border-gray-300 text-aaron-700 focus:ring-aaron-700" />
                        <label for="false" class="ml-2 block text-sm font-medium leading-6 text-white">No</label>
                    </div>
                ...
                <div class="mt-2 sm:col-span-6 sm:mt-0 md:pr-2">
                    <div>
                        ...
                        <div class="mt-2">
                            <textarea @change="autosaveLocally()" v-model="stepForm.medical_conditions" rows="3" name="medical_conditions" id="medical_conditions" class="block w-full rounded-md border-0 py-1.5 text-aaron-50 bg-aaron-950  shadow-sm ring-1 ring-inset ring-aaron-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-aaron-500 sm:text-sm sm:leading-6"></textarea>
                        </div>
                    </div>
                </div>
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
