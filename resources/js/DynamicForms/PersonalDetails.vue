...
async function autosaveLocally(){
    ...
    stepForm.first_name = props.formData.model.first_name;
    stepForm.middle_name = props.formData.model.middle_name;
    stepForm.last_name = props.formData.model.last_name;
    stepForm.title = props.formData.model.title;
    stepForm.salutation = props.formData.model.salutation;
    stepForm.date_of_birth = props.formData.model.date_of_birth;
    stepForm.gender = props.formData.model.gender;
    stepForm.marital_status = props.formData.model.marital_status;
    stepForm.nationality = props.formData.model.nationality;
    stepForm.ni_number = props.formData.model.ni_number;
    stepForm.country_of_domicile = props.formData.model.country_of_domicile;
    stepForm.country_of_residence = props.formData.model.country_of_residence;
    stepForm.valid_will = props.formData.model.valid_will;
    stepForm.will_up_to_date = props.formData.model.will_up_to_date;
    stepForm.poa_granted = props.formData.model.poa_granted;
    stepForm.poa_name = props.formData.model.poa_name;
}
        ...
        <div class="form-row flex-1">
            <div class="grid gap-2 md:grid md:grid-cols-6 md:items-start md:gap-y-8 md:gap-x-4">
                ...
                <div class="mt-2 md:mt-0 md:pr-2 md:col-span-3">
                    ...
                    <div class="flex shadow-sm  rounded-md  focus-within:ring-2 focus-within:ring-inset focus-within:ring-red-300 sm:max-w-md">
                        <input @change="autosaveLocally()" v-model="stepForm.salutation" type="text" name="salutation" id="salutation"  class="block ring-1 ring-inset ring-aaron-500 flex-1 border-0 rounded-md  bg-aaron-950 py-1.5 pl-2 text-aaron-50 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none" placeholder="Salutation" />
                    </div>
                ...
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                    ...
                    <select @change="autosaveLocally()" v-model="stepForm.gender" id="unit" name="gender"  class="block rounded-md  w-full  border-0 py-1.5 bg-aaron-700 text-aaron-50 sm:max-w-md shadow-sm ring-1 ring-inset ring-aaron-600 focus:ring-2 focus:ring-inset focus:ring-red-300  sm:text-sm sm:leading-6 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none">
                ...
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                    ...
                    <select @change="autosaveLocally()" v-model="stepForm.marital_status" id="unit" name="marital_status"  class="block rounded-md  w-full  border-0 py-1.5 bg-aaron-700 text-aaron-50 sm:max-w-md shadow-sm ring-1 ring-inset ring-aaron-600 focus:ring-2 focus:ring-inset focus:ring-red-300  sm:text-sm sm:leading-6 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none">
                ...
                <div class="mt-2 md:mt-0 md:pr-2 md:col-span-3">
                    ...
                    <div class="flex shadow-sm rounded-md  focus-within:ring-2 focus-within:ring-inset focus-within:ring-red-300 sm:max-w-md">
                        <input @change="autosaveLocally()" v-model="stepForm.ni_number" type="text" name="ni_number" id="ni_number"  class="block ring-1 ring-inset ring-aaron-500 flex-1 border-0 rounded-md bg-aaron-950 py-1.5 pl-2 text-aaron-50 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none" placeholder="National Insurance Number" />
                    </div>
                ...
                <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                    ...
                    <select @change="autosaveLocally()" v-model="stepForm.country_of_residence" id="unit" name="country_of_residence"  class="block rounded-md  w-full  border-0 py-1.5 bg-aaron-700 text-aaron-50 sm:max-w-md shadow-sm ring-1 ring-inset ring-aaron-600 focus:ring-2 focus:ring-inset focus:ring-red-300  sm:text-sm sm:leading-6 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none">
                ...
                <div class="col-span-6 grid grid-cols-6 rounded-md bg-aaron-950 pt-2 p-4">
                    ...
                    <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                        ...
                        <div class="pt-1 flex items-center space-x-4 space-y-0 md:mt-0 md:pr-2 md:col-span-2">
                            <input @change="autosaveLocally()" v-model="stepForm.valid_will" type="radio" id="true" :value="true" :checked="stepForm.valid_will == true" class="h-4 w-4 border-gray-300 text-aaron-700 focus:ring-aaron-700" />
                            <label for="true" class="ml-2 block text-sm font-medium leading-6 text-white">Yes</label>
                            <input @change="autosaveLocally()" v-model="stepForm.valid_will" type="radio" id="false" :value="false" :checked="stepForm.valid_will == false" class="h-4 w-4 border-gray-300 text-aaron-700 focus:ring-aaron-700" />
                    ...
                    <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                        <div v-if="stepForm.valid_will == true">
                            ...
                            <div class="pt-1 flex items-center space-x-4 space-y-0 md:mt-0 md:pr-2 md:col-span-2">
                                <input @change="autosaveLocally()" v-model="stepForm.will_up_to_date" type="radio" id="true" :value="true" :checked="stepForm.will_up_to_date == true" class="h-4 w-4 border-gray-300 text-aaron-700 focus:ring-aaron-700" />
                                <label for="true" class="ml-2 block text-sm font-medium leading-6 text-white">Yes</label>
                                <input @change="autosaveLocally()" v-model="stepForm.will_up_to_date" type="radio" id="false" :value="false" :checked="stepForm.will_up_to_date == false" class="h-4 w-4 border-gray-300 text-aaron-700 focus:ring-aaron-700" />
                                <label for="false" class="ml-2 block text-sm font-medium leading-6 text-white">No</label>
                            </div>
                ...
                <div class="col-span-6 grid grid-cols-6 rounded-md bg-aaron-950 pt-2 p-4">
                    ...
                    <div class="mt-2 sm:col-span-3 sm:mt-0 md:pr-2">
                        ...
                        <div class="pt-1 flex items-center space-x-4 space-y-0 md:mt-0 md:pr-2 md:col-span-2">
                            <input @change="autosaveLocally()" v-model="stepForm.poa_granted" type="radio" id="true" :value="true" :checked="stepForm.poa_granted == true" class="h-4 w-4 border-gray-300 text-aaron-700 focus:ring-aaron-700" />
                            <label for="true" class="ml-2 block text-sm font-medium leading-6 text-white">Yes</label>
                            <input @change="autosaveLocally()" v-model="stepForm.poa_granted" type="radio" id="false" :value="false" :checked="stepForm.poa_granted == false" class="h-4 w-4 border-gray-300 text-aaron-700 focus:ring-aaron-700" />
                            <label for="false" class="ml-2 block text-sm font-medium leading-6 text-white">No</label>
                        </div>
                    ...
                    <div class="mt-2 md:mt-0 md:pr-2 md:col-span-3">
                        <div v-if="stepForm.poa_granted == true">
                            ...
                            <div class="flex shadow-sm rounded-md  focus-within:ring-2 focus-within:ring-inset focus-within:ring-red-300 sm:max-w-md">
                                <input @change="autosaveLocally()" v-model="stepForm.poa_name" type="text" name="poa_name" id="poa_name"  class="block ring-1 ring-inset ring-aaron-500 flex-1 border-0 rounded-md bg-aaron-950 py-1.5 pl-2 text-aaron-50 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none" placeholder="Attorney Name" />
                            </div>
