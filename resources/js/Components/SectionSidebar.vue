...
<template>
    ...
    <aside id="default-sidebar" class="sticky top-56 z-[400] md:top-auto h-1/4 w-full md:w-80 mb-8 sm:hidden md:block md:h-fit md:absolute md:mb-0" aria-label="Sidebar">
