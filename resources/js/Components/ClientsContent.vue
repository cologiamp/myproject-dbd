    ...
    <div class="flex flex-col gap-8 min-h-[650px]">
        <div class="w-full flex flex-row items-center justify-between">
            ...
            <div class="flex flex-row items-center gap-12">
                <div class="flex flex-row items-center justify-between border-b border-b-[rgba(255,255,255,0.4)] min-w-[340px]">
                    <input
                        v-model="search"
                        type="text"
                ...
                <select v-model="select" class="block w-fit border-aaron-300 py-1.5 bg-aaron-950 ring-aaron-300 rounded-md text-aaron-50 shadow-sm focus:ring-aaron-400 sm:max-w-xs sm:text-sm sm:leading-6 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none min-w-[160px]">
