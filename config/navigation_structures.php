...
return [
    ...
    */
    ...
    'pensionobjectives' => [
        //PENSIONOBJECTIVES:// you need to make one of these for every step
        1 => [
            ...
            'sections' => [
                1 => [
                    'name' => 'General',
                    'fields' => [
                        "retirements.intended_retirement_at",
                        "retirements.intended_benefits_drawn_at",
                        "retirements.income_option",
                        "retirements.notes",
                    ],
                    'rules' => [
                        'intended_retirement_at' => 'sometimes|date',
                        'intended_benefits_drawn_at' => 'sometimes|date',
                        'income_option' => [
                            'sometimes',
                            'numeric',
                            'integer',
                ...
                2 => [
                    'name' => 'HMRC Lifetime Allowance protection',
                    'fields' => [
                        "health.lifetime_allowance_protection",
                        "health.health_details",
                        "health.has_life_expectancy_concerns",
                        "health.life_expectancy_details",
                        "health.medical_conditions",
        ...
        3 => [
            ...
            'sections' => [
                ...
                2 => [
                    'name' => 'Sources of pension income',
                    'fields' => [
                        'assets' => [
                            'assets.owner',
                            'assets.type',
                ...
                3 => [
                    'name' => 'Spouse/Partner´s Pensions',
                    'rules' => [
                        'investments' => 'sometimes|array',
                        'investments.*.id' => 'sometimes|nullable|integer',
                        'investments.*.owner' => 'sometimes|nullable',
